...
import { Direction, GridCell, RenderObject, boardCoordinate, canvasCoordinate, moveInfo, vector } from "../types.js";
...
abstract class Ghost extends Entity {
	...
	monsterPenState: MonsterState = MonsterState.IDLE_IN_PEN;
